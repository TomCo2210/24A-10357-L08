...
public class DataManager {
    ...
    public static ArrayList<Movie> getMovies() {
        ...
        movies.add(new Movie()
                .setName("Wonka")
                .setGenre(new ArrayList<String>(Arrays.asList("Comedy", "Family", "Fantasy")))
                .setActors(new ArrayList<String>(Arrays.asList("Timothée Chalamet", "Calah Lane", "Keegan-Michael Key", "Hugh Grant")))
                .setLength(117)
        ...
        movies.add(new Movie()
                ...
                .setGenre(new ArrayList<String>(Arrays.asList("Action", "Comedy", "Science Fiction")))
                .setActors(new ArrayList<String>(Arrays.asList("Ryan Reynolds", "Hugh Jackman", "Morena Baccarin", "Emma Corrin")))
                .setLength(119)
        ...
        movies.add(new Movie()
                .setName("The Marvels")
                .setGenre(new ArrayList<String>(Arrays.asList("Science Fiction", "Adventure", "Action")))
                .setActors(new ArrayList<String>(Arrays.asList("Brie Larson", "Teyonah Parris", "Iman Vellani", "Samuel L. Jackson")))
                .setLength(105)
        ...
        movies.add(new Movie()
                ...
                .setGenre(new ArrayList<String>(Arrays.asList("Action", "Adventure", "Fantasy")))
                .setActors(new ArrayList<String>(Arrays.asList("Jason Momoa", "Patrick Wilson", "Yahya Abdul-Mateen II", "Nicole Kidman")))
                .setLength(124)
        ...
        movies.add(new Movie()
                ...
                .setGenre(new ArrayList<String>(Arrays.asList("Drama", "Science Fiction", "Action")))
                .setActors(new ArrayList<String>(Arrays.asList("Tom Blyth", "Rachel Zegler", "Hunter Schafer", "Peter Dinklage")))
                .setLength(157)
        ...
        movies.add(new Movie()
                .setName("Oppenheimer")
                .setGenre(new ArrayList<String>(Arrays.asList("Drama", "History")))
                .setActors(new ArrayList<String>(Arrays.asList("Cillian Murphy", "Emily Blunt", "Matt Damon", "Robert Downey Jr.")))
                .setLength(181)
        ...
        movies.add(new Movie()
                ...
                .setGenre(new ArrayList<String>(Arrays.asList("Science Fiction", "Adventure", "Action")))
                .setActors(new ArrayList<String>(Arrays.asList("Chris Pratt", "Zoe Saldaña", "Dave Bautista", "Karen Gillan")))
                .setLength(210)
        ...
        movies.add(new Movie()
                ...
                .setGenre(new ArrayList<String>(Arrays.asList("History", "Drama")))
                .setActors(new ArrayList<String>(Arrays.asList("Zac Efron", "Jeremy Allen White", "Harris Dickinson", "Maura Tierney")))
                .setLength(132)
        ...
        movies.add(new Movie()
                .setName("Elemental")
                .setGenre(new ArrayList<String>(Arrays.asList("Animation", "Comedy", "Family", "Fantasy", "Romance", "Adventure")))
                .setActors(new ArrayList<String>(Arrays.asList("Leah Lewis", "Mamoudou Athie", "Ronnie del Carmen", "Shila Ommi")))
                .setLength(102)
        ...
        movies.add(new Movie()
                .setName("The Flash")
                .setGenre(new ArrayList<String>(Arrays.asList("Action", "Adventure", "Science Fiction")))
                .setActors(new ArrayList<String>(Arrays.asList("Ezra Miller", "Sasha Calle", "Michael Keaton", "Michael Shannon")))
                .setLength(144)
        ...
        movies.add(new Movie()
                .setName("Barbie")
                .setGenre(new ArrayList<String>(Arrays.asList("Comedy", "Adventure")))
                .setActors(new ArrayList<String>(Arrays.asList("Margot Robbie", "Ryan Gosling", "America Ferrera", "Kate McKinnon")))
                .setLength(114)
        ...
        movies.add(new Movie()
                .setName("Argylle")
                .setGenre(new ArrayList<String>(Arrays.asList("Comedy", "Action", "Crime")))
                .setActors(new ArrayList<String>(Arrays.asList("Bryce Dallas Howard", "Henry Cavill", "Bryan Cranston", "Catherine O'Hara")))
                .setLength(139)
        ...
        movies.add(new Movie()
                ...
                .setGenre(new ArrayList<String>(Arrays.asList("Adventure", "Action", "Drama")))
                .setActors(new ArrayList<String>(Arrays.asList("Archie Madekwe", "David Harbour", "Orlando Bloom", "Darren Barnet")))
                .setLength(135)
        ...
        movies.add(new Movie()
                .setName("גן קופים")
                .setGenre(new ArrayList<String>(Arrays.asList("Drama", "Comedy")))
                .setActors(new ArrayList<String>(Arrays.asList("אדיר מילר", "סוזנה פפיאן", "שני כהן", "יניב ביטון")))
                .setLength(121)
